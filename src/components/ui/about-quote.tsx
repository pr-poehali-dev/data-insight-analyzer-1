        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Bazaar — это современный маркетплейс, где каждый может купить или продать что угодно: от квартир и автомобилей до редких коллекционных вещей. Мы объединяем покупателей и продавцов по всей стране.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Наша миссия — сделать каждую сделку простой, быстрой и безопасной. Независимо от того, продаёте ли вы старый диван или ищете квартиру своей мечты — Bazaar здесь, чтобы помочь.
            </p>
          </div>
        </div>
      </div>
